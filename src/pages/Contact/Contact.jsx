...
const Contact = () => {
  ...
  return (
    <>
      <div className="background-layer-contact"></div>
      <div className="contact-container">
        <div className="contact-left">
          <div className="contact-text">
            <div className = "contact-header">
                <h1 className="contact-title" id = "customer">CUSTOMER</h1>
                <h1 className="contact-title" id = "service">SERVICE</h1>
                <p className = "contact-p">Want to get in touch? Contact our customer service with a press of a button!</p>
            </div>
          </div>
